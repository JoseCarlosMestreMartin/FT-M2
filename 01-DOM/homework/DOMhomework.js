...
// Tu código acá:
document.querySelector("#createdBy").innerHTML += " jose";
...
function buildToDo(todo, index) {
  ...
  if (todo.complete) {
    toDoText.setAttribute("class", "completeText"); //6
  }
...
function addToDo() {
  // Tu código acá:
  var myToDo = new ToDo(document.querySelector("#toDoInput").value); // 1
  document.querySelector("#toDoInput").value && toDoItems.push(myToDo); // 2
